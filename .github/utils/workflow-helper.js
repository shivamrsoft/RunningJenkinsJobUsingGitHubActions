              ...
              for (let run of runs.data.workflow_runs) {
                if (run.event === "pull_request_target") {
                  if (!returnData.pullRequestId) {
                    console.log(
                      "Skipping pull_request_target from non-pull-request build " +
                        run.html_url
                    );
                    continue;
                  }
                  if (run.head_repository && run.head_repository.fork) {
                    console.log(
                      "Skipping pull_request_target from fork " +
                ...
                if (
                  ...
                  console.log(
                    `Found successful build for branch ${branchName}`
                  );
                  ...
                  console.log(
                    `Found build ${run.run_number} was status: ${run.status} conclusion:${run.conclusion}`
                  );
                }
              }
            }
